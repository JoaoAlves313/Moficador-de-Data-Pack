...
const AiAssistantModal: React.FC<AiAssistantModalProps> = ({ isOpen, onClose, data, headers, fileName, onApplyBulkEdit, currentFilterName }) => {
    ...
    >
      ...
      >
        ...
        <div className="flex-grow p-6 space-y-4 overflow-y-auto">
          ...
          <div className="space-y-3">
              <div>
                  <label htmlFor="target-column" className="block text-sm font-medium text-gray-400 mb-1">1. Selecione a coluna para editar (opcional para perguntas)</label>
                  <select
                      id="target-column"
                      value={targetColumn}
              ...
              <div>
                  <label htmlFor="ai-prompt" className="block text-sm font-medium text-gray-400 mb-1">2. Descreva a alteração ou faça uma pergunta</label>
                  <textarea
                      id="ai-prompt"
